...
<div class="stat-value"><input type="number" oninput="calcMod(this)"></div>
<div class="stat-mod">0</div>

<div class="stat-name">Destrezza</div>
<div class="stat-value"><input type="number" oninput="calcMod(this)"></div>
<div class="stat-mod">0</div>

<div class="stat-name">Costituzione</div>
<div class="stat-value"><input type="number" oninput="calcMod(this)"></div>
<div class="stat-mod">0</div>

<div class="stat-name">Intelligenza</div>
<div class="stat-value"><input type="number" oninput="calcMod(this)"></div>
<div class="stat-mod">0</div>

<div class="stat-name">Saggezza</div>
<div class="stat-value"><input type="number" oninput="calcMod(this)"></div>
<div class="stat-mod">0</div>
...
function salvaPG(){
    ...
    for(let i=0;i<classInputs.length;i++){
        ...
        if(c && l > 0){
            ...
            alert(`La riga classe ${i+1} non è compilata correttamente. Assicurati che il nome non sia vuoto e il livello sia maggiore di 0.`);
            return;
        }
    }
...
<div class="statgrid-header">Valore</div>
<div class="statgrid-header">Mod</div>
<div class="statgrid-header"></div>

<div class="stat-name">Forza</div>
<div class="stat-value"><input type="number" value="${pg.stats[0]}" data-base="${pg.stats[0]}" oninput="gestioneStat(this,0)"></div>
<div class="stat-mod">${((Math.floor((pg.stats[0]-10)/2)>=0?"+":"") + Math.floor((pg.stats[0]-10)/2))}</div>
<div class="statbtn">
${aumentoDisponibile ? `
...
<div class="stat-name">Destrezza</div>
<div class="stat-value"><input type="number" value="${pg.stats[1]}" data-base="${pg.stats[1]}" oninput="gestioneStat(this,1)"></div>
<div class="stat-mod">${((Math.floor((pg.stats[1]-10)/2)>=0?"+":"") + Math.floor((pg.stats[1]-10)/2))}</div>
<div class="statbtn">
${aumentoDisponibile ? `
...
<div class="stat-name">Costituzione</div>
<div class="stat-value"><input type="number" value="${pg.stats[2]}" data-base="${pg.stats[2]}" oninput="gestioneStat(this,2)"></div>
<div class="stat-mod">${((Math.floor((pg.stats[2]-10)/2)>=0?"+":"") + Math.floor((pg.stats[2]-10)/2))}</div>
<div class="statbtn">
${aumentoDisponibile ? `
...
<div class="stat-name">Intelligenza</div>
<div class="stat-value"><input type="number" value="${pg.stats[3]}" data-base="${pg.stats[3]}" oninput="gestioneStat(this,3)"></div>
<div class="stat-mod">${((Math.floor((pg.stats[3]-10)/2)>=0?"+":"") + Math.floor((pg.stats[3]-10)/2))}</div>
<div class="statbtn">
${aumentoDisponibile ? `
...
<div class="stat-name">Saggezza</div>
<div class="stat-value"><input type="number" value="${pg.stats[4]}" data-base="${pg.stats[4]}" oninput="gestioneStat(this,4)"></div>
<div class="stat-mod">${((Math.floor((pg.stats[4]-10)/2)>=0?"+":"") + Math.floor((pg.stats[4]-10)/2))}</div>
<div class="statbtn">
${aumentoDisponibile ? `
...
<div class="stat-name">Carisma</div>
<div class="stat-value"><input type="number" value="${pg.stats[5]}" data-base="${pg.stats[5]}" oninput="gestioneStat(this,5)"></div>
<div class="stat-mod">${((Math.floor((pg.stats[5]-10)/2)>=0?"+":"") + Math.floor((pg.stats[5]-10)/2))}</div>
<div class="statbtn">
${aumentoDisponibile ? `
...
function nuovaSessione(index){
    ...
    if (xpInput === null) { // User pressed cancel
        return;
    }
