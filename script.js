...
const SKILLS_CONFIG = {
    ...
    "Addestrare Animali": { stat: 5, label: "CHA" },
    "Artigianato": { stat: 3, label: "INT" },
    "Artista della Fuga": { stat: 1, label: "DES"},
    "Ascoltare": { stat: 4, label: "SAG" },
    "Camuffare": { stat: 5, label: "CHA" },
    "Cavalcare": { stat: 1, label: "DES" },
    "Cercare": { stat: 3, label: "INT" },
    "Concentrazione": { stat: 2, label: "COS" },
    "Conoscenze (arcane)": { stat: 3, label: "INT" },
    "Conoscenze (architettura e ingegneria)": { stat: 3, label: "INT" },
    "Conoscenze (dungeon)": { stat: 3, label: "INT" },
    "Conoscenze (geografia)": { stat: 3, label: "INT" },
    "Conoscenze (locali)": { stat: 3, label: "INT" },
    "Conoscenze (natura)": { stat: 3, label: "INT" },
    "Conoscenze (nobiltà e regalità)": { stat: 3, label: "INT" },
    "Conoscenze (piani)": { stat: 3, label: "INT" },
    "Conoscenze (religioni)": { stat: 3, label: "INT" },
    "Conoscenze (storia)": { stat: 3, label: "INT" },
    ...
    "Guarire": { stat: 4, label: "SAG" },
    "Intimidire": { stat: 5, label: "CHA" },
    "Intrattenere": { stat: 5, label: "CHA" },
    "Muoversi Silenziosamente": { stat: 1, label: "DES" },
    "Nascondersi": { stat: 1, label: "DES" },
    "Nuotare": { stat: 0, label: "FOR" },
    "Osservare": { stat: 4, label: "SAG" },
    "Percepire Intenzioni": { stat: 4, label: "SAG" },
    "Professione": { stat: 4, label: "SAG" },
    "Raccogliere Informazioni": { stat: 5, label: "CHA" },
    "Raggirare": { stat: 5, label: "CHA" },
    "Rapidità di Mano": { stat: 1, label: "DES" },
    "Saltare": { stat: 0, label: "FOR" },
    "Sapienza Magica": { stat: 3, label: "INT" },
    "Scalare": { stat: 0, label: "FOR" },
    "Scassinare Serrature": { stat: 1, label: "DES" },
    "Sopravvivenza": { stat: 4, label: "SAG" },
    "Utilizzare Oggetti Magici": { stat: 5, label: "CHA" },
    "Utilizzare Corde": { stat: 1, label: "DES" },
    "Valutare": { stat: 3, label: "INT" }
};
